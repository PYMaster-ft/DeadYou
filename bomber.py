...
| $$  | $$| $$_____/ /$$__  $$| $$  | $$    | $$ | $$  | $$| $$  | $$
| $$$$$$$/|  $$$$$$$|  $$$$$$$|  $$$$$$$    | $$ |  $$$$$$/|  $$$$$$/
|_______/  \_______/ \_______/ \_______/    |__/  \______/  \______/  
                                         """
...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("DeadYou was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update.DeadYou")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/cham2003/DeadYou.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/cham2003/DeadYou.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
            "https://raw.githubusercontent.com/cham2003/DradYou/master/.version"
            ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("DradYou is up-to-date")
        mesgdcrt.GeneralMessage("Starting DradYou")


def notifyen():
    try:
        noti = requests.get(
            "https://raw.githubusercontent.com/cham2003/DeadYou/master/.notify"
            ).text.upper()
        if len(noti) > 10:
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("DeadYou was created by cham2003")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("DeadYou will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['cham2003', 't0xic0der', 'scpketer', 'Stefan']

ALL_COLORS = [Fore.GREEN, Fore.RED, Fore.YELLOW, Fore.BLUE,
              Fore.MAGENTA, Fore.CYAN, Fore.WHITE]
RESET_ALL = Style.RESET_ALL

description = """DeadYou - Your Friendly Spammer Application

DeadYou can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

DeadYou is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by cham2003 !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start DeadYou with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start DeadYou with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start DeadYou with MAIL Bomb mode")
parser.add_argument("-u", "--update", action="store_true",
                    help="update DeadYou")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current DeadYou contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current DeadYou version")
